    ...
    if (loadingCourse) {
        return (
            <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Loading Guidelines & Course Content...</p>
            </div>
        );
    }
        ...
        <div className="p-4 lg:p-8 max-w-7xl mx-auto min-h-screen bg-slate-50/50">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-12">
                <div className="space-y-1">
                    <h1 className="text-4xl font-black text-slate-900 tracking-tight uppercase italic">Guidelines & Docs</h1>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-10 pb-24">
                    ...
                    <div className="flex gap-2 mb-4 bg-white p-2 rounded-2xl border border-slate-100 shadow-sm w-fit">
                        {[1, 2, 3].map((pNum) => (
                            <button
                                ...
                                className={`px-5 py-2.5 rounded-xl text-[11px] font-black uppercase tracking-widest transition-all ${activeCoursePage === pNum ? 'bg-sky-500 text-white shadow-md font-black scale-105' : 'text-slate-400 hover:bg-slate-50'}`}
                            >
                                Page {pNum} Editor
                            </button>
                        ))}
                    ...
                    <div className="bg-white rounded-[44px] border border-slate-100 shadow-sm p-8">
                        <div className="flex items-center justify-between mb-8 border-b border-slate-50 pb-6">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-black text-slate-800 tracking-tight uppercase">Onboarding Course Editor</h3>
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Page {activeCoursePage} Content</p>
                                </div>
                            </div>
                            <button onClick={handleUpdateCourse} className="bg-slate-900 hover:bg-black text-white px-6 py-3.5 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-xl flex items-center gap-2 hover:scale-105 transition-all"><Save size={14} /> Save Page Changes</button>
                        </div>
                        ...
                        {activeCoursePage === 1 && (
                            <div className="space-y-6 animate-in fade-in duration-300">
                                ...
                                <div className="space-y-4 pt-4 border-t border-slate-50">
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Earning Methods</label>
                                    {courseData.page1.methods?.map((method, mIdx) => (
                                        <div key={mIdx} className="bg-slate-50 rounded-3xl p-5 border border-slate-100 relative space-y-3">
                                            ...
                                            <div className="space-y-2 pl-3">
                                                <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Bullet Points</label>
                        ...
                        {activeCoursePage === 2 && (
                            <div className="space-y-6 animate-in fade-in duration-300">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 bg-sky-50/40 rounded-3xl border border-sky-100/60 shadow-sm">
                                    <div className="space-y-3">
                                        <div className="flex items-center justify-between">
                                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Brand Logo URL</label>
                                            {courseData.page2.logoUrl && (
                                                <a href={courseData.page2.logoUrl} target="_blank" rel="noreferrer" className="text-[9px] font-black text-sky-500 hover:underline uppercase tracking-wider flex items-center gap-1">
                                                    View Current Logo
                                                </a>
                                            )}
                                        </div>
                                        ...
                                        <div className="relative group/upload bg-white rounded-xl border-2 border-dashed border-slate-200 hover:border-sky-500 transition-all flex items-center justify-center py-2 px-4 shadow-sm">
                                            ...
                                            />
                                            <span className="text-[9px] font-black uppercase tracking-widest text-slate-400 group-hover/upload:text-sky-500 flex items-center gap-1.5">
                                                {uploadingLogo ? (
                                                    <>
                                ...
                                <div className="space-y-4 pt-4 border-t border-slate-50">
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Steps list (Timeline)</label>
                ...
                <div className="space-y-4">
                    <h4 className="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-4 flex items-center gap-2 italic">User Course View Preview <ChevronRight size={12} /></h4>
                    
                    <div className="bg-slate-100 rounded-[50px] p-6 border-8 border-slate-200 shadow-2xl relative h-[720px] overflow-hidden flex flex-col scale-95 origin-top">
                        {/* Emulated Notch */}
                        <div className="absolute top-4 left-1/2 -translate-x-1/2 w-32 h-6 bg-black rounded-b-3xl z-50"></div>
                        
                        <div className="flex-1 bg-white rounded-[32px] overflow-hidden flex flex-col relative shadow-inner">
                            {/* Header */}
                            <div className="p-5 bg-slate-900 text-white flex justify-between items-center shrink-0 pt-7">
                                <div>
                                    <span className="text-[8px] font-black text-sky-400 uppercase tracking-widest">Dromoney Onboarding</span>
                                    <h1 className="text-md font-black tracking-tight leading-none mt-1">Earning Guide (Page {activeCoursePage}/3)</h1>
                                </div>
                                <div className="text-[10px] font-black text-white/40 uppercase bg-white/5 border border-white/10 px-2 py-1 rounded-md">
                            ...
                            <div className="flex-1 p-5 overflow-y-auto space-y-5 bg-slate-50 custom-scrollbar pb-16">
                                {activeCoursePage === 1 && (
                                    <div className="space-y-4">
                                        <h2 className="text-md font-black text-slate-800 leading-snug">{courseData.page1.title}</h2>
                                        ...
                                        <div className="bg-white rounded-2xl border border-slate-100 p-4 shadow-sm space-y-4">
                                            <h3 className="text-[11px] font-black text-slate-700 uppercase tracking-wider">{courseData.page1.methodsTitle}</h3>
                                            {courseData.page1.methods?.map((m, idx) => (
                                                <div key={idx} className="space-y-1 pb-2 border-b border-slate-50 last:border-none">
                                                    <h4 className="text-[11px] font-black text-sky-600">{m.title}</h4>
                                                    {m.points?.map((p, pIdx) => (
                                ...
                                {activeCoursePage === 2 && (
                                    <div className="space-y-4">
                                        <h2 className="text-md font-black text-slate-800 leading-snug">{courseData.page2.title}</h2>
                                            ...
                                            {courseData.page2.steps?.map((step, idx) => (
                                                <div key={idx} className="bg-white rounded-2xl border border-slate-100 p-3.5 shadow-sm space-y-1">
                                                    <div className="flex items-center gap-2">
                                                        <span className="text-[10px] font-black text-orange-500 uppercase tracking-widest">{step.stepNum}</span>
                                                        <h3 className="text-[11px] font-black text-slate-800">{step.title}</h3>
                                                    </div>
                                                    ...
                                                    {step.stepNum?.includes('Step 3') && (
                                                        <button className="w-full mt-2 py-2 bg-slate-900 text-white rounded-lg font-black text-[9px] uppercase tracking-wider flex items-center justify-center gap-1">
                                        ...
                                        <div className="bg-amber-50 rounded-2xl border border-amber-100 p-4 space-y-2">
                                            <h3 className="text-[11px] font-black text-amber-800 flex items-center gap-1"><AlertTriangle size={12} /> {courseData.page2.step5Title}</h3>
                                            <p className="text-[10px] font-bold text-slate-600 leading-relaxed">{courseData.page2.step5Details}</p>
                                            <button className="w-full py-2 bg-amber-600 text-white rounded-lg font-black text-[9px] uppercase tracking-widest flex items-center justify-center gap-1">
                                        ...
                                        {/* Templates */}
                                        <div className="space-y-3">
                                            <h3 className="text-[11px] font-black text-slate-700 uppercase tracking-widest">{courseData.page2.templatesTitle}</h3>
                                ...
                                {activeCoursePage === 3 && (
                                    <div className="space-y-4 animate-in fade-in">
                                        <h2 className="text-md font-black text-slate-800 leading-snug">{courseData.page3.title}</h2>
                                        
                                        {/* Daily Plan */}
                                        <div className="bg-white rounded-2xl border border-slate-100 p-4 shadow-sm space-y-2">
                                            <h3 className="text-[11px] font-black text-slate-700 uppercase tracking-wider">{courseData.page3.dailyPlanTitle}</h3>
                                        ...
                                        <div className="bg-gradient-to-br from-slate-900 to-indigo-950 rounded-2xl p-4 shadow-md text-white space-y-2 relative overflow-hidden">
                                            ...
                                            <h3 className="text-[11px] font-black text-sky-400 uppercase tracking-wider">{courseData.page3.exampleTitle}</h3>
                                            {courseData.page3.examples?.map((ex, idx) => (
                                                <p key={idx} className="text-[11px] font-black whitespace-pre-wrap">{ex}</p>
                                            ))}
                                        </div>

                                        {/* Rules */}
                                        <div className="bg-rose-50/50 rounded-2xl border border-rose-100 p-4 space-y-2">
                                            <h3 className="text-[11px] font-black text-rose-800 flex items-center gap-1 uppercase tracking-wider"><AlertCircle size={12} /> {courseData.page3.rulesTitle}</h3>
                                            {courseData.page3.rules?.map((rule, idx) => (
