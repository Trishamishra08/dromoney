            ...
            <div ref={scrollRef} className="flex-1 overflow-y-auto p-4 space-y-4">
                ...
                {isExpired && (
                    <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 text-center space-y-4 shadow-sm">
                        ...
                        <p className="text-[11px] text-amber-600 font-bold leading-relaxed px-4 uppercase tracking-widest">Your 3-month free trial has ended. Renew to continue chatting with experts.</p>
                        <button 
                            onClick={handleRenew}
