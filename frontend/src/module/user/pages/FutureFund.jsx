...
const FutureFund = () => {
    ...
    if (loadingSettings) {
        return (
            <div className="p-8 text-center text-slate-800 min-h-screen bg-slate-50 flex flex-col items-center justify-center font-bold tracking-wider gap-3">
                <Loader2 className="animate-spin text-blue-600 w-10 h-10" />
                <p className="text-xs uppercase font-extrabold text-slate-400">Loading Fund Dashboard...</p>
            </div>
        );
    }
    ...
    if (viewState === 'active') {
        return (
            <div className="flex flex-col min-h-screen bg-[#F8FAFC] animate-in slide-in-from-right duration-500 pb-12 font-sans selection:bg-blue-100">
                {/* ── Compact Header ── */}
                <div className="p-4 bg-white border-b border-slate-100 flex items-center justify-between sticky top-0 z-40 shadow-sm">
                    <div className="flex items-center gap-3">
                        <button onClick={() => setViewState('initial')} className="text-slate-600 active:scale-90 transition-all">
                            <ChevronLeft size={22} strokeWidth={2.5} />
                        </button>
                        <h1 className="text-[15px] font-black text-slate-800 tracking-tight uppercase">Future Fund Active</h1>
                    </div>
                    <span className="bg-emerald-50 text-emerald-600 px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-wider border border-emerald-100">Active Stage</span>
                </div>

                <div className="p-4 space-y-3.5 max-w-md mx-auto w-full">
                    {/* Compact Congratulations Banner */}
                    <div className="bg-emerald-50/50 border border-emerald-100 rounded-2xl p-3.5 flex items-center gap-3 shadow-sm">
                        <span className="text-2xl shrink-0">🎉</span>
                        <div>
                            <h4 className="text-[12px] font-black text-emerald-800 leading-none">Congratulations!</h4>
                            <p className="text-[10px] font-bold text-emerald-600/90 mt-1 leading-snug">आप Future Fund के लिए eligible हो गए हैं।</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white border border-slate-100 rounded-2xl overflow-hidden shadow-sm">
                        <div className="px-4 py-3 border-b border-slate-50 bg-slate-50/50 flex items-center justify-between">
                            <h4 className="text-[9px] font-black text-slate-600 uppercase tracking-widest">Last 7 Days Earnings</h4>
                    ...
                    <div className="bg-white border border-slate-100 rounded-2xl p-4 shadow-sm space-y-3.5">
                        <div className="flex items-center justify-between border-b border-slate-50 pb-2">
                            ...
                            <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Dynamic</span>
                        </div>
                        ...
                        <div className="space-y-1">
                            <div className="flex justify-between items-center text-[11px] font-bold text-slate-600">
                                ...
                                <span className={`font-black ${isBoosterActiveCount > 0 ? 'text-rose-500' : 'text-slate-400'}`}>
    ...
    return (
        <div className="flex flex-col min-h-screen bg-slate-50 relative overflow-hidden animate-in slide-in-from-right duration-500 pb-10 font-sans">
            ...
            <div className="flex-1 space-y-3.5 relative z-10 max-w-md mx-auto w-full">
                ...
                <div className="w-full bg-gradient-to-br from-purple-700 via-purple-600 to-indigo-500 rounded-b-[2rem] p-4 pb-6 text-white relative overflow-hidden shadow-xl">
                    ...
                    <div className="relative z-10 flex flex-col items-center mt-2">
                        <div className="flex items-center gap-2 mb-3">
                            <div className="w-8 h-8 bg-white/20 backdrop-blur-md rounded-xl flex items-center justify-center border border-white/20 shadow-lg">
                                <TrendingUp size={16} className="text-white" />
                            </div>
                            <div className="text-left">
                                <h2 className="text-[14px] font-black tracking-tight leading-none uppercase">Future Fund</h2>
                                <p className="text-[7px] font-bold text-white/70 uppercase tracking-widest mt-0.5">Eligibility Program</p>
                            </div>
                        </div>
                        ...
                        <div className="w-full max-w-[260px] bg-white/10 backdrop-blur-md rounded-xl px-3 py-2 border border-white/10">
                            <div className="flex justify-between items-center mb-1">
                                <span className="text-[8px] font-black uppercase tracking-widest text-white/80">Progress Status</span>
                                <span className="text-[11px] font-black">90%</span>
                            </div>
                ...
                <div className="px-4 space-y-3.5">
                    ...
                    <div className="bg-slate-900 rounded-2xl p-4 shadow-xl relative overflow-hidden border-b-4 border-purple-500">
                        ...
                        <h3 className="text-[8px] font-black text-purple-400 uppercase tracking-[0.25em] mb-2 flex items-center gap-2">
                            <Sparkles size={11} />
                            PROGRAM INSIGHT
                        </h3>
                        <p className="text-[12px] font-bold text-slate-300 leading-normal italic border-l-2 border-purple-500/50 pl-3">
                    ...
                    <div className="grid grid-cols-1 gap-2.5">
                        ...
                        <div className="relative bg-white p-3.5 shadow-sm border border-slate-100 transition-all rounded-2xl">
                            <div className="flex justify-between items-center">
                                <div className="flex items-center gap-2.5">
                                    ...
                                    <div>
                                        <h4 className="text-[12px] font-black text-slate-800 uppercase leading-none">Successful Sales</h4>
                                        <p className="text-[8px] font-bold text-slate-400 uppercase tracking-wider mt-0.5">Target Milestone</p>
                                    </div>
                                </div>
                                <span className="bg-slate-50 border border-slate-100 px-2 py-0.5 rounded-lg text-[10px] font-black text-slate-700">10/10</span>
                            </div>
                        ...
                        <div className="relative bg-white p-3.5 shadow-sm border border-slate-100 transition-all rounded-2xl">
                            <div className="flex justify-between items-center">
                                <div className="flex items-center gap-2.5">
                                    ...
                                    <div>
                                        <h4 className="text-[12px] font-black text-slate-800 uppercase leading-none">Daily Activity</h4>
                                        <p className="text-[8px] font-bold text-slate-400 uppercase tracking-wider mt-0.5">Time Tracker</p>
                                    </div>
                                </div>
                                <span className="bg-slate-50 border border-slate-100 px-2 py-0.5 rounded-lg text-[10px] font-black text-slate-700">15m/15m</span>
                            </div>
                            <div className="w-full h-1 bg-slate-100 rounded-full mt-2.5 overflow-hidden">
                        ...
                        <div className="relative bg-white p-3.5 shadow-sm border border-slate-100 transition-all rounded-2xl">
                            <div className="flex justify-between items-center">
                                <div className="flex items-center gap-2.5">
                                    ...
                                    <div>
                                        <h4 className="text-[12px] font-black text-slate-800 uppercase leading-none">Active Days</h4>
                                        <p className="text-[8px] font-bold text-slate-400 uppercase tracking-wider mt-0.5">Continuity Goal</p>
                                    </div>
                                </div>
                                <span className="bg-slate-50 border border-slate-100 px-2 py-0.5 rounded-lg text-[10px] font-black text-slate-700">6/7</span>
                            </div>
                            <div className="w-full h-1 bg-slate-100 rounded-full mt-2.5 overflow-hidden">
                        ...
                        <div className="bg-slate-950 text-white p-3.5 rounded-2xl flex gap-2.5 items-center">
                            ...
                            <p className="text-[9.5px] font-bold text-slate-300 leading-snug">
                                आपका समय <span className="text-white font-extrabold">स्वचालित रूप से</span> गिना जाएगा। 15 मिनट = 1 दिन।
                            </p>
                        </div>
                        ...
                        <div className="pt-1.5 space-y-2.5">
                            <button
                                ...
                                className="w-full bg-slate-900 hover:bg-black border-b-4 border-purple-600 text-white font-black py-3.5 shadow-lg rounded-2xl active:scale-[0.98] transition-all text-[13px] tracking-wider uppercase flex items-center justify-center gap-2"
                            >
                                MOVE FORWARD ➔
                            </button>
