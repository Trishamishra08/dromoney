    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#F0FDF4] animate-in fade-in duration-700 pb-20">
            ...
            <div className="sticky top-0 z-50 bg-white/95 backdrop-blur-xl border-b border-emerald-100/50 px-6 py-4 flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-[17px] font-black text-slate-900 tracking-tight leading-none uppercase">Information Center</h1>
                    <p className="text-[10px] font-bold text-emerald-600 uppercase tracking-widest mt-1">Earning Guide & Mastery</p>
                </div>
            </div>
            ...
            <div className="px-4 py-4 space-y-5">
                ...
                <div className="text-center py-6">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm border border-slate-100 mb-4">
                        ...
                        <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Knowledge is Wealth</span>
                    </div>
                    <p className="text-[9px] font-black text-slate-300 uppercase tracking-[0.3em] leading-none">Powered by Drowmoney Intelligence</p>
                </div>
            </div>
